...
<form action="../../../backend/controlador/patrocinadores_controlador.php" method="POST" enctype="multipart/form-data" name="Patrocinadores" class="needs-validation" novalidate>
