...
<div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre" value="<?php echo $trabajadores->nombre ?>" required maxlength="20" >
              <div class="valid-feedback">
                Se ve bien!
              </div>
              <div class="invalid-feedback">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" name="apellido" id="apellido" value="<?php echo $trabajadores->apellido ?>" placeholder="Apellido" >
              <div class="valid-feedback">
                Se ve bien!
              </div>
              <div class="invalid-feedback">
            ...
            <div class="col-md-4 mb-3">
              <label for="apellido">Ocupación</label> 
              <input type="text" class="form-control" name="ocupacion" id="ocupacion" value="<?php echo $trabajadores->ocupacion ?>"   >
              <div class="valid-feedback">
                Se ve bien!
              </div>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="email" class="form-control" name="email" id="email" value="<?php echo $trabajadores->email ?>" placeholder="Email" >
              <div class="valid-feedback">
                Se ve bien!
              </div>
              <div class="invalid-feedback">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="password" name="pass" id="pass" value="<?php echo $trabajadores->pass?>" class="form-control mx-sm-3" aria-describedby="passwordHelpInline" >
