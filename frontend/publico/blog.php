                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-title text-center">
                            <h2><span> UNA EXPERIENCIA </span>ÚNICA</h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="folio-item">
                            <div class="text-folio text-center">
                                <h2 class="text-1">GENERAL</h2>
                                <h2 class="text-2">GENERAL</h2>
                            </div>
                        </div>
                        <div class="folio-item">

                            <div class="img-folio cursorExplore">
                                <a class="load-spiral" href="">
                                    <img class="img-fluid" src="imagenes/general.jpg" draggable="false" alt="">
                                </a>
                            </div>
                            <div class="text-folio text-center">
                                <h2 class="text-1">$2,999<sup>.99</sup></h2>
                                <h2 class="text-2">$2,999<sup>.99</sup></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="folio-item">
                            ...
                            <div class="img-folio cursorExplore">
                                <a class="load-spiral" href="portafolioWeb.html">
                                    <img class="img-fluid" src="assets/img/EmotionArtboard20.png" draggable="false" alt="">
                                </a>
                            </div>
                            <div class="text-folio text-center">
                                <h2 class="text-1">WEB</h2>
                                <h2 class="text-2">WEB</h2>
                            </div>
                        </div>
                        ...
                        <div class="folio-item">
                            ...
                            <div class="img-folio cursorExplore">
                                <a class="load-spiral" href="productora.html">
                                    <img class="img-fluid" src="assets/img/EmotionArtboard22.png" draggable="false" alt="">
                                </a>
                            </div>
                            <div class="text-folio text-center">
                                <h2 class="text-1">PRODUCTORA</h2>
                                <h2 class="text-2">PRODUCTORA</h2>
                            </div>
                        </div>
                    </div>
                </div>
