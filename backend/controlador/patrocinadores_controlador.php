        ...
        case 1: //create
            if(isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['monto']) && isset($_FILES['foto']) &&  isset($_REQUEST['descripcion']) && isset($_REQUEST['zona'])){
                ...
                if($resultado == 1){
                   ...
                   header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=registrado");

                }else{
                   header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=No_registrado");
            ...
            if((isset($_REQUEST['id']) && isset($_REQUEST['nombre']) && isset($_REQUEST['monto'])
               &&  isset($_REQUEST['descripcion']) && isset($_REQUEST['zona'])) || isset($_FILES['foto'])){
                ...
                if($resultado==1){
                    ...
                    header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=Actualizado");
                }
            }else{
                header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=No_actualizado");
                }  
              break;
        ...
        case 3: //delete
            ...
            if (isset($_REQUEST['id'])) {
                ...
                if($resultado == 1){
                    ...
                    header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=borrado");
                }else{
                   header("Location: ../../../../../coronalobby.mx/frontend/privado/patrocinadores/index_trabajador.php?estatus=No_borrado");
